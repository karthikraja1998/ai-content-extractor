...
export namespace Prisma {
  ...
  */
  ...
  export type ContentOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    "id" | "url" | "summary" | "keyPoints" | "createdAt",
    ExtArgs["result"]["content"]
  >;
  ...
  type ContentGetPayload<
    S extends boolean | null | undefined | ContentDefaultArgs,
  > = $Result.GetResult<Prisma.$ContentPayload, S>;
  ...
  > {
    ...
    updateManyAndReturn<T extends ContentUpdateManyAndReturnArgs>(
      args: SelectSubset<T, ContentUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$ContentPayload<ExtArgs>,
        T,
